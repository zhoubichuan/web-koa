  ...
  themeConfig: {
    ...
    locales: {
      '/': {
        ...
        sidebar: {
          '/base/build/': ['1.config', '2.Koa', '3.file', '4.single', '5.page', '7.module', '8.project', '9.utils', '10.ui', '11.data', '12.skill', '13.com', '14.data', '15.api'],
          '/base/function/': ['skill', 'bug', 'Koa', 'vscode', 'test', 'prem', 'i18n'],
